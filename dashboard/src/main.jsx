...
function ProjectMark() {
  return <svg className="project-mark" viewBox="0 0 48 48" aria-hidden="true"><circle cx="24" cy="24" r="20" /><circle cx="24" cy="24" r="13" /><path d="M24 24 38 10" /><path d="M24 24 33 34" /><circle className="project-mark-core" cx="24" cy="24" r="3.5" /><circle className="project-mark-signal" cx="38" cy="10" r="3" /></svg>
}
